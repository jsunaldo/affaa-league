...
// site.bin, news.bin and lineups.bin are URL-versioned (?v=<salt prefix>) so cache-first is always safe:
...
const CACHE = 'affaa-v2';   // v2 (2026-09-11): all three payloads cache-first + versioned
